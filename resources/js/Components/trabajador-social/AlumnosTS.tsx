  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <Tabs defaultValue="todos" className="w-full">
        ...
        {/* Otros tabs filtrarían por estado */}
        <TabsContent value="normal">
          <Card className="border-[#E5E7EB]">
            <CardContent className="pt-6">
              <p className="text-center text-[#6B7280]">Alumnos sin problemas reportados</p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="atencion">
          <Card className="border-[#E5E7EB]">
            <CardContent className="pt-6">
              <p className="text-center text-[#6B7280]">Alumnos que requieren atención</p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="critico">
          <Card className="border-[#E5E7EB]">
            <CardContent className="pt-6">
              <p className="text-center text-[#6B7280]">Alumnos en situación crítica</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
